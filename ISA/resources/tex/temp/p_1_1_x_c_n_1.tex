...
\section{ Caso di studio : Grafo $P_1^{( 1)}\times C_12^{( 1)}$  } 
...
\bigskip Definiamo $T(n,k)$ il numero di $k$-sottoinsiemi indipendenti di Grafo $P_1^{( 1)}\times C_12^{( 1)}$ . \\Ecco alcuni valori\par
...
\begin{tabular}{ll} 
	...
	$u_i \longrightarrow\  e_z $\\
	$u \longrightarrow\  e $\\
	$s \longrightarrow\  e + u_i $\\
	$u_1 \longrightarrow\  e_z $\\
	$e_z \longrightarrow\  e_z + u_1 $\\
\end{tabular}
\right.$$
...
\begin{tabular}{ll} 
	...
	$U_i \rightarrow e E_z  \mid \lambda $\\
	$S \rightarrow e E  \mid  u U_i  \mid \lambda $\\
	$U_1 \rightarrow e E_z   $\\
	$E_z \rightarrow e E_z  \mid  u U_1  \mid \lambda $\\
\end{tabular}
\right.$$
