...
\section{ Caso di studio : Grafo $P_2^{( 1)}\times C_5^{( 1)}$  } 
...
\begin{tabular}{ll} 
	...
	$(2;1) \longrightarrow\  (1;1), (2;2), (2;5),  $\\
...
\bigskip Definiamo $T(n,k)$ il numero di $k$-sottoinsiemi indipendenti di Grafo $P_2^{( 1)}\times C_5^{( 1)}$ . \\Ecco alcuni valori\par
