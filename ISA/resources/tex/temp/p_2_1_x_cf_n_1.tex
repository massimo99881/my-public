...
\section{ Caso di studio : Grafo $P_2^{( 1)}\times CF_5^{( 1)}$  } 
...
\begin{tabular}{ll} 
	...
	$(2;1) \longrightarrow\  (1;1), (1;2), (2;2), (2;5),  $\\
	...
	$(1;5) \longrightarrow\  (1;1), (1;4), (2;4), (2;5),  $\\
	$(2;5) \longrightarrow\  (2;1), (2;4), (1;5),  $\\
\end{tabular}
\right.$$
...
(4) edge [] node[above] {} (1)(6) edge [] node[above] {} (3)(8) edge [] node[above] {} (5)(10) edge [] node[above] {} (7)(1) edge [bend left] node[above] {} (9)(2) edge [bend right] node[above] {} (10); \end{tikzpicture}$$ \subsection{Calcolo insiemi indipendenti con metodo forza bruta} \
...
\bigskip Definiamo $T(n,k)$ il numero di $k$-sottoinsiemi indipendenti di Grafo $P_2^{( 1)}\times CF_5^{( 1)}$ . \\Ecco alcuni valori\par
