...
//THANKS TO..http://algs4.cs.princeton.edu/41undirected/
public abstract class GridGraphImpl implements Graph {
	...
	public GridGraphImpl() {
	}
	
	public GridGraphImpl(int n, int m) {
		this.V = n*m;
		if (this.V < 0){
