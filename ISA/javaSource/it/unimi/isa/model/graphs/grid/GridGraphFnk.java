...
public class GridGraphFnk extends GridGraphImpl {
	
	public GridGraphFnk(int n, int m, int[] potenzaCamminoVerticale, int[] potenzaCamminoOrizzontale) {
		super(n, m);
		this.n = n;
		this.m = m;
		this.q = this.n - 1;
	...
	public boolean hasRicorrenzaLineare() {
		 ...
		 * m=1
		 */
		if( "p_1_1 x f_n_1".equalsIgnoreCase(nome)){
		...
		else if( "p_1_1 x f_n_2".equalsIgnoreCase(nome)){
		...
		else if( "p_1_1 x f_n_3".equalsIgnoreCase(nome)){
		...
		else if( "p_1_1 x f_n_e3".equalsIgnoreCase(nome)){
			schema = new String [5][2];
			schema[4][1] = "{1}"; schema[4][0] = "{0}";
			schema[3][1] = "{-1}"; schema[3][0] = "{0}";
			schema[2][1] = "{1}"; schema[2][0] = "{0}";
		 ...
		 * m=2
		 */
		if( "p_2_1 x f_n_1".equalsIgnoreCase(nome)){
			schema = new String [4][3];
			schema[3][2] = "{1}"; schema[3][1] = "{0}"; schema[3][0] = "{0}";
			schema[2][2] = "{0}"; schema[2][1] = "{2}"; schema[2][0] = "{0}";
			schema[1][2] = "{0}"; schema[1][1] = "{0}"; schema[1][0] = "{1}";
			schema[0][2] = "{0}"; schema[0][1] = "{0}"; schema[0][0] = "{*}";
			
			sigma = new Sigma(schema.length-1, schema[0].length-1,schema);
			//TODO
			sigma.setFuncGenH(new String[]{"1","1+2x","1+4x+x^2"}); 
